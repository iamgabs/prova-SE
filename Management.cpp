...
jogador_t jogador2 = {PA_6, PA_5, 0};

Management::Management(int w, int h)
...
void Management::movePlayers() {
    ...
    if (jogador1.y.read() > 0.7 && player1y > 0) {
        player1.moveUp();
    } else if (jogador1.y.read() < 0.3 && player1y + 4 < height) {
        player1.moveDown();
    }

    if (jogador2.y.read() > 0.7 && player2y > 0) {
        player2.moveUp();
    } else if (jogador2.y.read() < 0.3 && player2y + 4 < height) {
        player2.moveDown();
    }
